...
@CucumberOptions(features = { "src/test/resources/features" }, glue = { "com/cucumber/stepdefination" }, plugin = {
		...
		monochrome = true, dryRun = false, strict = true, tags = {"@Sanity"})

public class SanityTestCasesExecution extends AbstractTestNGCucumberTests {
	
	//Sanity, Regression, End to End test cases - suites
